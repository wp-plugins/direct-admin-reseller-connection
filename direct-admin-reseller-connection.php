...
<table bordercolor="#fff" border="1">
	...
	<?php echo '<tr><td>price</td><td>number</td><td>'.__('0', 'darc-nh').'</td><td>'.__('Price of the pack seperated by a - with multiple packages. No price will hide the price field', 'darc-nh').'</td></tr>'; ?>
