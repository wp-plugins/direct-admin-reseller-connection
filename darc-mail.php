...
if(isset($_POST['darc_nh_new_forwarder_alias']) AND isset($_POST['darc_nh_new_forwarder_domein']) AND filter_var($_POST['darc_nh_new_forwarder_email'], FILTER_VALIDATE_EMAIL)){
	...
	echo '<h2>'. __('Mailboxes', 'darc-nh').'</h2>';
            ...
            echo '<div class="table-responsive"><table width="100%" class="table table-hover"><tr><th></th><th>'. __('alias', 'darc-nh').'</th><th></th><th>'. __('domain', 'darc-nh').'</th><th>'. __('size', 'darc-nh').'</th><th>'. __('used', 'darc-nh').'</th><th></th></tr>';
...
<?php
	echo '<h2>'. __('Forwarders', 'darc-nh').'</h2>';
	  ...
	  echo '<div class="table-responsive"><table class="table table-hover" style="width:100%;"><tr><th></th><th>'. __('address', 'darc-nh').'</th><th></th><th>'. __('receiver', 'darc-nh').'</th><th></th></tr>';
