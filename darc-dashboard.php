...
function dashboard_widget_darc_nh() { darc_nh_version();
 	echo '<table width="100%" class="table table-hover">
		<tr><td></td><td><b>'. __('Used', 'darc-nh').'</b></td><td><b>'. __('Max.', 'darc-nh').'</b></td></tr>
		<tr><td>'. __('Disk size', 'darc-nh').'</td><td>'.mb_to_gb(darc_list_reseller_usage("quota","usage")).'</td><td>'; if(darc_list_reseller_usage("quota","usage") != "unlimited"){ echo mb_to_gb(darc_list_reseller_usage("quota","")); 
		...
		<tr><td>'. __('Bandwidth', 'darc-nh').'</td><td>'.mb_to_gb(darc_list_reseller_usage("bandwidth","usage")).'</td><td>'; if(darc_list_reseller_usage("bandwidth","usage") != "unlimited"){ echo mb_to_gb(darc_list_reseller_usage("bandwidth",""));
