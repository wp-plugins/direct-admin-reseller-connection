...
if($_POST['darc_nh_domein']){
  if($_POST['darc_nh_website'] != ""){
	...
	echo '<h2>'. __('Domain forwarders', 'darc-nh').'</h2>';
		...
		echo '<b>'.$domein.':</b><br> <input type="text" name="darc_nh_domein" value='.$domein.' hidden> <input type="text" name="darc_nh_website" value="'.darc_list_pointer($domein).'" style="width: 400px;">';
